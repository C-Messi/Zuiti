...
export function SettingPanel(): React.JSX.Element {
  ...
  const isPaused = Boolean(s.visionPausedUntil && s.visionPausedUntil > now)
  ...
  return (
    ...
    >
      ...
      {/* Settings panel */}
      {open && (
        <div className="panel-enter mt-2 w-52 rounded-2xl backdrop-blur-xl bg-white/95 border border-white/70 p-3 shadow-xl">
          {/* Vision toggle */}
